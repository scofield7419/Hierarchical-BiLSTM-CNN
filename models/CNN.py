...
maxlen = 1024 * 10  # 512  # 一个文档的token最长长度（max sequence length）
...
# mlp
hidden_dim_1 = 20
output_dim = 3  # 三分类，做出二进制标签，只需2维;或者（0，1，0）的三维
...
###喂入词token对应的id即可
text_input = Input(shape=(maxlen,), dtype='int32', name="cnn")
...
#########MLP
hiden1 = Dense(hidden_dim_1)(densed)
...
with open(save_data_path_selected_data_path + "/log_cnn.txt", 'a+') as f:
    f.write(store_str)
